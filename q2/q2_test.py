...
class Tests(unittest.TestCase):
  def test_rackspace_provided_case(self):
    ...
    expected_output = ['The  quick brown fox',
                       'jumps  over the lazy',
                       'dog.']
    output = q2_alternate.justify_string(20, input)
  ...
  def test_string_less_than_width(self):
    ...
    output = q2_alternate.justify_string(80, input)
    self.assertEquals(output, expected_output)
  ...
  def test_find_spaces(self):
    ...
    output = q2_alternate.find_spaces(input)
    self.assertEquals(output, expected_output)
  ...
  def test_pad_line(self):
    ...
    expected_output = 'The  quick brown fox'
    output = q2_alternate.pad_line(input, 20)
    self.assertEquals(output, expected_output)

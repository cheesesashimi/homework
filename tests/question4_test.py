...
import unittest
from homework import question4
...
class Tests(unittest.TestCase):
  def test_rackspace_provided_string(self):
    ...
    """
    output = question4.reduce_string('abb cddpddef gh')
  ...
  def test_no_spaces(self):
    ...
    """
    output = question4.reduce_string('za ch a r y')
  ...
  def test_no_trailing_spaces(self):
    ...
    output = question4.reduce_string('asdfe ')
    self.assertEquals(-1, output.find(' '))
